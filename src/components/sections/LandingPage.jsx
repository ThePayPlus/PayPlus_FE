                ...
                <nav className="w-full px-6 py-4">
                    ...
                    {isMenuOpen && (
                        <div className="md:hidden mt-4">
                            <a
                                href="User?menu=login"
                                className="block bg-indigo-500 text-white px-6 py-2 rounded-full hover:bg-indigo-600 transition duration-300 text-center"
                            >
                                Log in
                            </a>
                        </div>
                    ...
                    <div className="container mx-auto flex flex-col md:flex-row items-center">
                        ...
                        <div className="md:w-1/2 mb-16 md:mb-0">
                            ...
                            <p className="text-xl mb-8 text-gray-600 leading-relaxed">
                                PayPlus helps you manage money, track expenses, and achieve your
                                financial goals with ease and precision.
                            </p>
                            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                <a
                                    href="User?menu=signup"
                                    className="bg-indigo-500 text-white font-semibold px-8 py-3 rounded-full hover:bg-indigo-600 transition duration-300 text-center hover:scale-105"
                                >
                                    Get Started
                                </a>
                            </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-12">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-600">
                                    Set and track budgets with a list of budgets and a very intuitive
                                    interface.
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-600">
                                    Automatically categorize and analyze your spending habits.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            <div className="bg-white p-8 rounded-lg shadow-sm">
                                <p className="text-gray-600 mb-4">
                                    "PayPlus mengubah cara aku ngatur keuangan. Gampang banget
                                    dipakai, fiturnya keren, dan yang bikin seru, ngatur budget jadi
                                    lebih asyik."
                                </p>
                            ...
                            <div className="bg-white p-8 rounded-lg shadow-sm">
                                <p className="text-gray-600 mb-4">
                                    "Pakai PayPlus, ngatur uang jadi jauh lebih simpel. Fiturnya
                                    lengkap, gampang dipahami, dan bikin budgeting terasa ringan dan
                                    menyenangkan. Top deh pokoknya 😊"
                                </p>
                                <div className="flex items-center">
                                    <img
